...
public class UserControllerTest {
	...
	@BeforeEach
	public void cleanup() {
		userRepository.deleteAll(); // Reset the database before running each test
	...
	@Test
	public void getUsers_whenPageSizeNotProvided_receiveDefaultPageSizeAs10() {
		ResponseEntity<TestPage<Object>> response = getUsers(new ParameterizedTypeReference<TestPage<Object>>() {});
		assertThat(response.getBody().getSize()).isEqualTo(10);
	}	
	
	@Test
	public void getUsers_whenPageSizeIsGreaterThan100_receiveMaxPageSizeAs100() {
	...
	@Test
	public void getUsers_whenPageSizeIsNegative_receiveDefaultPageSizeAs10() {
	...
	public void putUser_withValidRequestBodyWithGIFImageFromAuthorizedUser_receiveBadRequest() throws IOException {
		...
		authenticate(user.getUsername());
		UserUpdateVM updatedUser = createValidUserUpdateVM();
		/* Upload image in unsupported format */
